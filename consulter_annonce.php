...
<head>
    ...
    <title>Annonces sur le site-UMMTO annonce</title>
 ...
 try
        ...
        catch(Exception $e)
        {
               ...
               // $sql="SELECT titre,description,date(date_publi) as d, hour(date_publi) as h, minute(date_publi) as m from  
                 ...
                 $req=$bdd->query("SELECT annonce.id_annonce,annonce.titre,annonce.description,date(date_public) as d, hour(date_public) as h, minute(date_public) as m FROM annonce WHERE annonce.valide='1' ORDER BY date_public DESC");     
    ...
    border: 0px;
    cursor:pointer;                                                          
    color: white;" onclick="document.location.href = 'supprimer_annonce.php?id=<?php echo $donnees3['id_annonce'];  ?>'">        
