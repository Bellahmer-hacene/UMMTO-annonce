...
<button onclick="myFunction()" class="dropbtn"><i class="fas fa-user"></i></button>
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Mes annonces</a>
    <a href="#about">Paramètres</a>
       </div></div>

   <?php } ?>
	   <a class ="posta" href="formulaire.html">+Poster une annonce</a> 	
	</header>
      ...
      <input id="recherche" class="search" type="search" placeholder="Recherche..." name="q" value="<?php if(!empty($q)) echo $q;  ?>"><button id="sub" style="padding:9px 9px 5px 9px" type="submit"><i class="fa fa-search"></i></button>
    </form>
		...
		<ul id="menu">
			...
			<li><div id="categorie_5" class="categorie"><a href="categorie.php?c=sortie">Découverte/<br><span style="color:white">0</span> Excursions</a></div>
                ...
                <article >
                 <div id= "info">   
              <div id ="desc">  
            <h3>Randonnée à Tamda Ouguelmim</h3>  

              <p>Incrusté, en plein coeur du Djurdjura, Tamda Ouguelmim (le lac Ougoulmim) scintille telle une émeraude, au coeur de la montagne, offrant un paysage pittoresque qui invite au repos et à la contemplation. Tamda Ouguelmim, comme tout "objet" précieux, ne s’offre pas facilement.Pour atteindre ce site idyllique, il faut avoir les jambes solides et l’esprit aventureux, pour braver les pistes escarpées et abruptes de la montagne, qui le préserve jalousement.Pour rejoindre ce site, situé à 1.700 mètres d’altitude.</p>    </div>
                 ...
                 <tr> </tr>
                  <tr>
                     ...
                     <th><i class="far fa-clock"></i>Heure de départ:</th>
                      <td>9h</td>
                      <th><i class="far fa-envelope"></i>Adresse mail</th>
                    <td>ummto@yahoo.fr</td>
                  <tr>
                  </tr>
                  <tr>
                      <th><i class="fas fa-map-marker-alt"></i>Lieux de départ:</th>
                      <td>Bastos</td>
                       <th><i class="fas fa-link"></i>Site web</th>
                    <td>www.google.dz</td>
                  </tr>
                   <tr>
                     <th><i class="fas fa-map-marker-alt"></i>Lieux d'arrivé:</th>
                      <td>Tamda Ouguelmim</td>
                  </tr>
                  <tr>
                      <th><i class="fas fa-money-bill"></i>Prix:</th>
                      <td>500 DA</td>   
                  </tr> <tr></tr><tr></tr></table>  </div>
                  <div class="slideshow-container">

<div class="mySlides fade">
  <img src="image/2.jpg" style="width: 900px;
    height: 500px ; ">
</div>

<div class="mySlides fade">
  <img src="image/11.jpg" style="width: 900px;
    height: 500px ;">
</div>

<div class="mySlides fade">
  <img src="image/3.jpg" style="width: 900px;
    height: 500px ;">
</div>
<div class="mySlides fade">
  <img src="image/4.jpg" style="width: 900px;
    height: 500px ;">
</div>
